...
from common.performance_profile import PERFORMANCE_PROFILES, apply_performance_profile, get_performance_profile_summary


def main():
    parser = argparse.ArgumentParser(
        description="Apply known-good Pyla-Biomistik performance settings without editing emulator internals."
    )
    parser.add_argument(
        "--profile",
    ...
    print("Pyla-Biomistik performance profile")
